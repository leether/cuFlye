#!/usr/bin/env python3
"""Compare cuFlye read-alignment-v1 TSV files."""
...
from validate_read_alignment_dump import Record, canonical_text, parse_record, validate
...
def compare(left: Path, right: Path, include_diff: bool = False,
            max_diff_lines: int = 200) -> dict:
...
def print_report(summary: dict) -> None:
    print(f"Read alignment dump diff: {summary['status']}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("left", help="Left read-alignment TSV")
    parser.add_argument("right", help="Right read-alignment TSV")
